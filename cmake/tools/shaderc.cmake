...
if( ${CMAKE_SYSTEM_NAME} MATCHES iOS|tvOS )
	target_link_libraries (shaderc PUBLIC "-framework OpenGLES  -framework Metal -framework UIKit -framework CoreFoundation -framework CoreGraphics -framework QuartzCore")
elseif( APPLE )
	...
	target_link_libraries( shaderc PUBLIC ${COCOA_LIBRARY} ${METAL_LIBRARY} ${QUARTZCORE_LIBRARY} )
	target_link_libraries( shaderc PUBLIC "-framework IOKit -framework CoreFoundation" )
endif()
